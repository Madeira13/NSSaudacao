...
public class NSSaudacao: NSObject {
    ...
    public class func msgWhatssApp() -> String {
        // Resgatar o período atual
        let periodo = NSSaudacao.definirPeriodo()
        ...
        //return msg sorteadalet pathFile = ((NSHomeDirectory() as NSString).appendingPathComponent("Documents") as NSString).appendingPathComponent(<file>);
